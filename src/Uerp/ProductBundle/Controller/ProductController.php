...
$response->headers->set('Content-Type', 'application/json');
 ...
 return $response;
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UerpProductBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("UerpProductBundle:Product:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UerpProductBundle:Product')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UerpProductBundle:Product:edit.html.twig")
     */
